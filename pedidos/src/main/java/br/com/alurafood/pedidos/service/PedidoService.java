...
public class PedidoService {
    ...
    // the model mapper is used to convert between the DTO and the entity
    // um exemplo seria receber um pedido e retornar um pedidoDto, assim fazemos menos requisições para a API.
